...
Function Get-ServiceProviderConnections{
  $connections = Get-Content -Raw -Path "$inputConnectionsFilePath" | ConvertFrom-Json
  return $connections.serviceProviderConnections
}
